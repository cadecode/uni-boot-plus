...
import com.github.cadecode.ubp.starter.cache.exception.DLCacheException;
...
import com.github.cadecode.ubp.starter.cache.l2cache.sync.DLCacheRefreshMsg;
...
public class DLCache extends AbstractValueAdaptingCache {
    ...
    protected Object lookup(Object key) {
        ...
        Object val;
        val = caffeineCache.getIfPresent(key.toString());
