...
import com.github.cadecode.ubp.starter.cache.exception.RedisLockException;
...
public class RedisLockKit {
     ...
     * <p>两种情况，假设当前持有锁的线程为 A 节点线程 A1，其他线程有 A 节点线程 A2，B 节点线程 B1：
     * <p>1. A 节点的线程清除了 A1 的锁，续期任务正常关闭
     * <p>2. B1 清除了其他节点持有的锁
     * <p>2.1 没有继续抢锁，A1 的续期任务会抛出异常后停止，并清理 contentMap
     * <p>2.2 B1 抢到锁，如果间隔时间没有达到续期任务周期，A1 的续期任务可能会无限执行下去
     * <p>2.3 A2 抢到锁，storeLock 时会关闭原续期任务
     *
     * @param name 锁名称
     */
