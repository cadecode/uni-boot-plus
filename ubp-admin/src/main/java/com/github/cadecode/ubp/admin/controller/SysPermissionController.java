...
public class SysPermissionController {
    ...
    @Operation(description = "根据主键删除系统权限")
    ...
    @Operation(description = "根据主键系统权限-批量")
     ...
     */
    @PutMapping("update")
    @Operation(description = "根据主键更新系统权限")
     ...
     */
    @GetMapping("get/{id}")
    @Operation(description = "根据主键查询系统权限")
    ...
    @Operation(description = "根据主键查询系统权限-批量")
     ...
     */
    @PostMapping("list")
    @Operation(description = "根据条件查询系统权限")
     ...
     */
    @PostMapping("page")
    @Operation(description = "分页查询系统权限")
