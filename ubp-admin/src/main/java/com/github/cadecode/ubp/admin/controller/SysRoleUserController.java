...
public class SysRoleUserController {
     ...
     */
    @PostMapping("save")
    @Operation(description = "保存角色用户关系")
    ...
    @Operation(description = "根据主键删除角色用户关系")
    ...
    @Operation(description = "根据主键角色用户关系-批量")
     ...
     */
    @PutMapping("update")
    @Operation(description = "根据主键更新角色用户关系")
     ...
     */
    @GetMapping("get/{id}")
    @Operation(description = "根据主键查询角色用户关系")
    ...
    @Operation(description = "根据主键查询角色用户关系-批量")
     ...
     */
    @PostMapping("list")
    @Operation(description = "根据条件查询角色用户关系")
     ...
     */
    @PostMapping("page")
    @Operation(description = "分页查询角色用户关系")
